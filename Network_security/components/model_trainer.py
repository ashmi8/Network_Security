...
from Network_security.entity.artifacts_entity import DataTransformationArtifact,ModelTrainerArtifact
...
import dagshub
dagshub.init(repo_owner='ashmijha8', repo_name='Network_Security', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        # mlflow.set_registry_uri("https://dagshub.com/ashmijha8/Network_Security.mlflow")
